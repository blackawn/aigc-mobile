...
import VerifyCode from '@/assets/icon/verify_code.svg'
...
const onInput = (e: Event) => {
  ...
  form.verifyCode = value.replace(/\D/g, '')
  ...
  <div class="h-screen overflow-hidden">
    <div class="flex h-full flex-col justify-center px-4">
      <div class="flex flex-col items-center">
        <span class="text-3xl text-black">验证码登录/注册</span>
        <span class="mt-2 text-xs text-[#969799]">未注册的手机号将自动注册并登录</span>
      </div>
      <div class="mt-10">
      ...
      <div class="mt-6 text-center">
        <span class="text-sm text-primary">使用验证码登录/注册</span>
      </div>
    </div>
  </div>
</template>
